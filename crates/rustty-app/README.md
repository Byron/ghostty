...
progress animation, hover scrolling and idle rendering. The report records animation
frame rate and the monitor's reported refresh rate. It writes `result.json`, `workspace.json` and a
