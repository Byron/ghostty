...
typedef enum {
  ...
  GHOSTTY_GOTO_SPLIT_QUADRANT_UP,
  GHOSTTY_GOTO_SPLIT_QUADRANT_LEFT,
  GHOSTTY_GOTO_SPLIT_QUADRANT_DOWN,
  GHOSTTY_GOTO_SPLIT_QUADRANT_RIGHT,
...
typedef enum {
  ...
  GHOSTTY_ACTION_TOGGLE_QUADRANT_ZOOM,
